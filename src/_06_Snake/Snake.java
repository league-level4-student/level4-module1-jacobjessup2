...
public class Snake {
	...
	public void update() {
		...
		case RIGHT:
				loc = new Location(snake.get(0).getLocation().x+1, snake.get(0).getLocation().y);
			break;
		case LEFT:
				loc = new Location(snake.get(0).getLocation().x-1, snake.get(0).getLocation().y);
			break;
		case UP:
				loc = new Location(snake.get(0).getLocation().x, snake.get(0).getLocation().y-1);
			break;
		case DOWN:
				loc = new Location(snake.get(0).getLocation().x, snake.get(0).getLocation().y+1);
			break;
	...
	public void reset(Location loc) {
		...
		Location headloc = new Location(_00_SnakeGame.WIDTH/3,_00_SnakeGame.HEIGHT/2);
	...
	public boolean isOutOfBounds() {
		...
		if(snake.get(0).getLocation().x>_00_SnakeGame.WIDTH) {
			return true;
		}
		if(snake.get(0).getLocation().y>_00_SnakeGame.HEIGHT) {
			return true;
		}
		return false;
	}
