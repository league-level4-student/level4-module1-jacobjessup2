...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public _00_SnakeGame() {
		snake = new Snake(new Location(WIDTH / 3, HEIGHT / 2));
	...
	public void startGame() {
		...
		String instructions = "Use the arrow keys to move the snake in the desired direction."
							+ "\nThe snake will constantly move. If you touch the walls or yourself"
							+ "\nyou will die. Grabbing the food will give you a higher score, "
							+ "\nbut it will make you longer. Good luck :)";
	...
	private void gameOver() {
		...
		JOptionPane.showMessageDialog(null, "You killed the snake, you monster!");
		//3. ask them if they want to play again.
		String[] options = {"Yes","No"};
		int input = JOptionPane.showOptionDialog(null, "Do you want to play again?", "Restart", 0, -1, null, options, 0);
		...
		switch(choice) {
		case "Yes":
			Location loc = new Location(WIDTH/3,HEIGHT/2);
			snake.reset(loc);
			startGame();
			break;
		case "No":
